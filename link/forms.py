...
class ReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'rating': forms.NumberInput(attrs={'class':'w-full mt-2 py-4 px-6 bg-slate-100 border-slate-300'}),
            'content': forms.Textarea(attrs={'class':'w-full mt-2 py-4 px-6 bg-slate-100 border-slate-300'})
        }